...
export default function ManageLessons() {
  ...
  if (loading) {
    return (
      <div className="manage-lessons-container" style={{ padding: "15px", background: colors.bg, minHeight: "100vh" }}>
        <style>{`
          @media (min-width: 768px) {
            .manage-lessons-container { padding: 30px !important; }
          }
          @keyframes pulse {
            0%, 100% { opacity: 1; }
            50% { opacity: .5; }
        ...
        {[1, 2, 3, 4, 5].map((item) => (
          <div key={item} style={{ background: "#fff", border: `1px solid ${colors.border}`, borderRadius: "10px", marginBottom: "12px", padding: "15px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
