          ...
          <div className="bg-white p-4 rounded-4 shadow-lg" style={{ maxWidth: "400px", width: "100%" }}>
            ...
            <div className="d-flex gap-2 justify-content-end">
              ...
              <button
                ...
                style={{ background: "#9f64f7", border: "none" }}
      ...
      <div className="container">
        <div className="d-lg-none mb-4">
          ...
          >
            ...
            <span className="badge bg-primary rounded-pill" style={{ background: "#9f64f7" }}>
                        ...
                        <div key={course._id} className="col-md-6 col-xl-4">
                          ...
                          >
                            <div className="position-relative">
                              ...
                              {isEnrolled && (
                                <span
                                  className="position-absolute top-0 end-0 m-3 badge rounded-pill p-2"
                                  style={{
                                    background: isCompleted ? "#00cec9" : "#6c5ce7",
                                    fontSize: "0.65rem",
                                  }}
                                >
